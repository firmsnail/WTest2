...
<title>Short-term Employees Management System</title>
...
<script src="${pageContext.request.contextPath}/resources/static/js/common/metisMenu.min.js"></script>

<!-- Custom Theme JavaScript -->
<script src="${pageContext.request.contextPath}/resources/static/js/common/sb-admin-2.js"></script>
